        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PracticalTasks_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MentorComment = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    Status = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PracticalSubmissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PracticalSubmissions_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PracticalSubmissions_PracticalTasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PracticalSubmissions_StudentId",
                table: "PracticalSubmissions",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_PracticalSubmissions_TaskId",
                table: "PracticalSubmissions",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_PracticalTasks_ModuleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestResults_TestId_StudentId",
                table: "TestResults",
